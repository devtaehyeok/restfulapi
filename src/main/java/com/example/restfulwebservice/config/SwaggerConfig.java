...
public class SwaggerConfig {
    private static final Contact DEFAULT_CONTACT =
            new Contact("TH LIM", "https://thlimtech.netlify.app/", "ith13579@korea.ac.kr");

    private static final ApiInfo DEFAULT_API_INFO =
            new ApiInfo("Awesome API Title", "My User management REST API service", "1.0", "urn:tos", DEFAULT_CONTACT, "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0", new ArrayList<>());
